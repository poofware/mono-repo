    ...
    Future<void> _launch(String url) async {
      ...
      if (!success && context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(appLocalizations.urlLauncherCannotLaunch),
          ),
        );
      }
    }
                ...
                children: [
                  ...
                  Card(
                    ...
                    child: ListTile(
                      ...
                      leading:
                          const Icon(Icons.email_outlined, size: 32, color: AppColors.poofColor),
                      title: Text(appLocalizations.emailSupportLabel,
